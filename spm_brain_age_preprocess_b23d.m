...
addpath('/apps/matlab_toolboxes/spm12');
% Parse arguments
if nargin < 1
...
matlabbatch{1}.spm.spatial.preproc.tissue(1).tpm = {'/apps/matlab_toolboxes/spm12/tpm/TPM.nii,1'};
matlabbatch{1}.spm.spatial.preproc.tissue(1).ngaus = 2;
matlabbatch{1}.spm.spatial.preproc.tissue(1).native = [1 1];
matlabbatch{1}.spm.spatial.preproc.tissue(1).warped = [0 0];
matlabbatch{1}.spm.spatial.preproc.tissue(2).tpm = {'/apps/matlab_toolboxes/spm12/tpm/TPM.nii,2'};
matlabbatch{1}.spm.spatial.preproc.tissue(2).ngaus = 2;
matlabbatch{1}.spm.spatial.preproc.tissue(2).native = [1 1];
matlabbatch{1}.spm.spatial.preproc.tissue(2).warped = [0 0];
matlabbatch{1}.spm.spatial.preproc.tissue(3).tpm = {'/apps/matlab_toolboxes/spm12/tpm/TPM.nii,3'};
matlabbatch{1}.spm.spatial.preproc.tissue(3).ngaus = 2;
matlabbatch{1}.spm.spatial.preproc.tissue(3).native = [1 1];
matlabbatch{1}.spm.spatial.preproc.tissue(3).warped = [0 0];
matlabbatch{1}.spm.spatial.preproc.tissue(4).tpm = {'/apps/matlab_toolboxes/spm12/tpm/TPM.nii,4'};
matlabbatch{1}.spm.spatial.preproc.tissue(4).ngaus = 3;
matlabbatch{1}.spm.spatial.preproc.tissue(4).native = [0 0];
matlabbatch{1}.spm.spatial.preproc.tissue(4).warped = [0 0];
matlabbatch{1}.spm.spatial.preproc.tissue(5).tpm = {'/apps/matlab_toolboxes/spm12/tpm/TPM.nii,5'};
matlabbatch{1}.spm.spatial.preproc.tissue(5).ngaus = 4;
matlabbatch{1}.spm.spatial.preproc.tissue(5).native = [0 0];
matlabbatch{1}.spm.spatial.preproc.tissue(5).warped = [0 0];
matlabbatch{1}.spm.spatial.preproc.tissue(6).tpm = {'/apps/matlab_toolboxes/spm12/tpm/TPM.nii,6'};
...
matlabbatch{2}.spm.tools.dartel.warp1.settings.param(1).template = {'/group/brain_age/BRAIN_AGE_T1/templates/Template_1.nii'};
...
matlabbatch{2}.spm.tools.dartel.warp1.settings.param(2).template = {'/group/brain_age/BRAIN_AGE_T1/templates/Template_2.nii'};
...
matlabbatch{2}.spm.tools.dartel.warp1.settings.param(3).template = {'/group/brain_age/BRAIN_AGE_T1/templates/Template_3.nii'};
...
matlabbatch{2}.spm.tools.dartel.warp1.settings.param(4).template = {'/group/brain_age/BRAIN_AGE_T1/templates/Template_4.nii'};
...
matlabbatch{2}.spm.tools.dartel.warp1.settings.param(5).template = {'/group/brain_age/BRAIN_AGE_T1/templates/Template_5.nii'};
...
matlabbatch{2}.spm.tools.dartel.warp1.settings.param(6).template = {'/group/brain_age/BRAIN_AGE_T1/templates/Template_6.nii'};
...
matlabbatch{3}.spm.tools.dartel.mni_norm.template = {'/group/brain_age/BRAIN_AGE_T1/templates/Template_6.nii'};
...
matlabbatch{4}.spm.util.tvol.mask = {'/apps/matlab_toolboxes/spm12/tpm/mask_ICV.nii,1'};
